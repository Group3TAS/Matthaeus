...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'tas_autonomous_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tas_group_03/catkin_ws/install/${idir}'.  Ask the maintainer 'laith <laith@todo.todo>' to fix it.")
    endif()
