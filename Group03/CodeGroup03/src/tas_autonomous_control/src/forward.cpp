//This node is utilized for test purposes. It allows the user to impose a speed (PWM-Signal) and an angle (degrees) directly on the motor
//Author: Group03
...
public:
  ...
  bool driveKeyboard()
  {
    ...
    //we send commands of type "twist"
...
int main(int argc, char** argv)
{
  ...
  //generate a new object (class Robot driver)
